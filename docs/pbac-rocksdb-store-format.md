...
As mentioned in the accompanying Rocks DB [documentation](pbac-rocksdb-label-store.md), 
Labels are stored in key/value pairs as byte arrays, with the key derived from the 
given RDF Triple and the value from the relevant security label.
---
## Values
...
classes implementing the Storage Format [interface](../rdf-pbac-lib/src/main/java/uk/gov/dbt/ndtp/jena/pbac/labels/StoreFmt.java)
...
## Keys - By String
### Overview
The [StoreFmtByString class](../rdf-pbac-lib/src/main/java/uk/gov/dbt/ndtp/jena/pbac/labels/StoreFmtByString.java) 
...
## Keys - By ID
### Overview
The [StoreFmtById class](../rdf-pbac-lib/src/main/java/uk/gov/dbt/ndtp/jena/pbac/labels/StoreFmtByNodeId.java)
