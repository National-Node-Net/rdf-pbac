# RDF PBAC: Fuseki Server
**Repository:** `rdf-pbac`  
**Description:** `Apache Jena Fuseki implementation`
<!-- SPDX-License-Identifier: OGL-UK-3.0 -->

The `rdf-pbac-fuseki-server` module provides a ready-to-go implementation of an Apache Jena Fuseki server that can be run immediately from the generated jar.
...
```bash
java -jar ../rdf-pbac-fuseki-server/target/rdf-pbac-fuseki-server-0.71.10-SNAPSHOT.jar --conf=../rdf-pbac-fuseki/src/test/files/server/documentation-example-config.ttl
```
...
As the names suggest, one is configured to make use of PBAC and the other is not.  
...
--data-binary '@../rdf-pbac-fuseki/src/test/files/server/documentation-example-data.trig'
```
