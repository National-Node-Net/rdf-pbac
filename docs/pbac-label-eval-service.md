# RDF PBAC - Attribute Label Evaluation Service
**Repository:** `rdf-pbac`  
**Description:** `Attribute based access control for RDF `    
<!-- SPDX-License-Identifier: OGL-UK-3.0 -->
The PBAC security engine is written in Java.
...
The Attribute Label Evaluator (ALE) is part of the secure layer of Integration Architecture Node. Like
