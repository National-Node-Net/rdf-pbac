...
/**
 * A Fuseki action to get the labels graph for a {@link DatasetGraphPBAC}.
 */
public class PBAC_Labels extends ActionService implements PBAC_Processor {
    ...
    public void validate(HttpAction action) {
        ...
        if ( !( dsg instanceof DatasetGraphPBAC ) ) {
            ...
            ServletOps.errorBadRequest("Not a PBAC dataset");
            return;
        }
    }
