...
/**
 * Ingest point for PBAC changes (data loading, RDF Patch and SPARQL Update).
 * <p>
 * This replaces the processor for {@link Operation#Upload}) which is RDF data only.
 */
public class PBAC_ChangeDispatch extends ActionService implements PBAC_Processor {

    // Having a PBAC-specific dispatcher control data change is more flexible
    ...
    // control or operation introspection when mixing AABC and non-PBAC datasets
    ...
    private final PBAC_DataLoader dataLoader = new PBAC_DataLoader();
