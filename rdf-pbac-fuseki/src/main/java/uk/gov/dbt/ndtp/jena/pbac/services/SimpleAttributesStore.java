...
package uk.gov.dbt.ndtp.jena.pbac.services;

import static uk.gov.dbt.ndtp.jena.pbac.services.LibAuthService.templateGetByName;
...
/**
 * One of the services used by rdf-pbac is an external service to lookup user attributes and hierarchies.
