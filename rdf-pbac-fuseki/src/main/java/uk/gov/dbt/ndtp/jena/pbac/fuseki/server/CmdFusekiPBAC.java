...
public class CmdFusekiPBAC {
    ...
    // Symbol name kept as "abac:debug" so existing server settings continue to work.
    private static Symbol debugPBAC = Symbol.create("abac:debug");
    ...
    public static void main(String ...args) {
        ...
        try {
            ...
            Fuseki.serverLog.error("Fuseki server failed", ex);
        } finally { server.stop(); }
    }
