...
import uk.gov.dbt.ndtp.jena.pbac.assembler.Secured;
...
public class TestAssemblerPBAC {
    static {
        JenaSystem.init();
    }
    ...
    @Test public void assemble_1() {
        DatasetGraphPBAC dsgz = assemble(DIR+"pbac-assembler-1.ttl");
    ...
    @Test public void assemble_2() {
        DatasetGraphPBAC dsgz = assemble(DIR+"pbac-assembler-2.ttl");
        assertNotNull(dsgz.labelsStore());
        assertNotNull(dsgz.attributesStore());
        dsgz.close();
    }
    ...
    @Test public void assemble_3() {
        DatasetGraphPBAC dsgz = assemble(DIR+"pbac-assembler-3.ttl");
        assertNotNull(dsgz.labelsStore());
        assertNotNull(dsgz.attributesStore());
        dsgz.close();
    }
    ...
    @Test public void assemble_label_store_1() {
        ...
        DatasetGraphPBAC dsgz = assemble(DIR+"pbac-assembler-label-store-1.ttl");
    ...
    @Test public void assemble_label_store_2() {
        ...
        DatasetGraphPBAC dsgz = assemble(DIR+"pbac-assembler-label-store-2.ttl");
        assertTrue(FileOps.exists(dirName), "No label store directory");
    ...
    @Test public void assemble_bad_1() {
        ...
        assembleBad(DIR+"pbac-assembler-bad-1.ttl");
    }

    @Test public void assemble_bad_2() {
        // Two auth:labelsStore
        assembleBad(DIR+"pbac-assembler-bad-2.ttl");
    }

    @Test public void assemble_bad_3() {
        // Two authz:labels in the dataset.
        assembleBad(DIR+"pbac-assembler-bad-3.ttl");
    }

    @Test public void assemble_bad_4() {
        // Empty linked object.
        assembleBad(DIR+"pbac-assembler-bad-4.ttl");
    }
    ...
    /*package*/ static DatasetGraphPBAC assemble(String filename) {
