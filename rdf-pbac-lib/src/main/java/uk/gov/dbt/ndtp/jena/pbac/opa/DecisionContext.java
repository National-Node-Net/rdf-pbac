 ...
 * <p>
 * Wraps the existing {@link CxtPBAC} (subject attributes, request id, per-request caches)
 * and adds the fields a PBAC decision needs that CxtPBAC does not yet carry: who is asking
 ...
 * values themselves (which live on the wrapped {@link CxtPBAC}).
 * <p>
...
public class DecisionContext {
    ...
    public DecisionContext(CxtPBAC cxt, String subjectId, String action, String organisationId, String datasetName) {
    ...
    /** Convenience: the request id carried by the underlying CxtPBAC. */
