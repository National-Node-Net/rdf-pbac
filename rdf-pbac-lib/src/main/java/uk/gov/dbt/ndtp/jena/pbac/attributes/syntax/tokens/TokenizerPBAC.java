 ...
 */
public final class TokenizerPBAC implements Tokenizer
{
    ...
    /*package*/ static TokenizerPBAC internal(PeekReader reader, boolean lineMode, ErrorHandler errorHandler) {
        return new TokenizerPBAC(reader, lineMode, errorHandler);
    }

    private TokenizerPBAC(PeekReader reader, boolean lineMode, ErrorHandler errorHandler) {
